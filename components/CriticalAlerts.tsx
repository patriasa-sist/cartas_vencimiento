...
import { 
  AlertTriangle, Clock, Mail, Phone, User, Building2,
  ChevronLeft, Calendar, FileText, Zap
} from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <Button variant="outline" className="text-red-600 border-red-300" disabled={selectedRecords.size === 0}>
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div className="space-y-1">
              ...
              <div className="text-gray-500">
                Valor: {formatCurrency(record.valorAsegurado || 0)}
              </div>
            </div>
